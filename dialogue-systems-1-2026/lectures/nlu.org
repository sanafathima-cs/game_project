...
- intent :: setAlarm
- entities :: {time: "2026-02-20 0900 CET"}
...
- O :: outside
  ...
  #+begin_src 
    ...
    Utterance:   wake me up [tomorrow] at [9]  please

    Entities:    O    O  O  B-TIME   I  I      O
    
    Entities:    O    O  O  B-DAY    O  B-HOUR O
...
O O    O   I   O   O      B-DES     O      B-DEPTIME            O 
